...
extern "C" spark_node_t* spark_create_function_node(Spark::symbolid_t id, Spark::datatype_t returnType, spark_error_t** error);
extern "C" spark_node_t* spark_create_symbol_node(Spark::datatype_t dt, Spark::symbolid_t id, spark_error_t** error);
...
// node property query
extern "C" Spark::nodetype_t spark_node_get_type(spark_node_t* node, spark_error_t** error);
extern "C" Spark::operator_t spark_node_get_operator_id(spark_node_t* node, spark_error_t** error);
extern "C" bool spark_node_get_attached(spark_node_t* node, spark_error_t** error);
extern "C" Spark::symbolid_t spark_node_get_function_id(spark_node_t* node, spark_error_t** error);
// node property set
